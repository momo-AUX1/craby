...
function NotFoundLogo({ className }: { className?: string }) {
  return (
    <svg
      role="img"
    ...
    >
      ...
      <g transform="translate(20, 0) rotate(10 50 100) scale(0.75)">
        <path
          d="M 40 80 Q 40 20, 120 20 Q 200 20, 200 80 Q 200 140, 120 160 L 120 220"
          stroke="currentColor"
          strokeWidth="35"
          strokeLinecap="round"
          strokeLinejoin="round"
      ...
      <g>
        ...
        <g transform="translate(0, -30) matrix(1,0,0,1,483.3,502.984)">
          <path
        ...
        <g transform="translate(0, -30) matrix(1,0,0,1,520.766,436.428)">
          <path
