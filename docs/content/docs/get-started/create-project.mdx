...
<Files>
  <Folder name="your-module" defaultOpen>
    <Folder name="src" defaultOpen>
      <File name="index.ts" icon={<TypeScriptIcon />} />
      <File name="NativeModule.ts" icon={<TypeScriptIcon />} />
    </Folder>
    <Folder name="crates" defaultOpen>
      <Folder name="lib" defaultOpen>
        <File name="Cargo.toml" icon={<TomlIcon />}/>
        <File name="build.rs" icon={<RustIcon />} />
        <Folder name="src" defaultOpen>
          <File name="lib.rs" icon={<RustIcon />} />
          <File name="ffi.rs" icon={<RustIcon />} />
          <File name="generated.rs" icon={<RustIcon />} />
        </Folder>
      </Folder>
    </Folder>
    <Folder name="cpp" disabled />
    <Folder name="android" defaultOpen>
      <File name="build.gradle" icon={<GradleIcon />} />
    ...
    <File name="Cargo.toml" icon={<TomlIcon />} />
    <File name="craby.toml" icon={<TomlIcon />} />
    <File name="rust-toolchain.toml" icon={<TomlIcon />} />
