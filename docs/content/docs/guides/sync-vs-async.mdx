...
```typescript title="NativeLightCompute.ts"
...
```rust title="light_compute_impl.rs"
#[craby_module]
...
- <TossFace>✅</TossFace> Operation completes in **< 16ms** (one frame at 60fps)
- <TossFace>✅</TossFace> Simple calculations or data transformations
- <TossFace>✅</TossFace> No heavy computations
- <TossFace>✅</TossFace> Immediate result is needed

**Examples of good sync methods:**

- <TossFace>👉</TossFace> Basic math calculations
- <TossFace>👉</TossFace> String formatting
- <TossFace>👉</TossFace> Simple data validation
- <TossFace>👉</TossFace> Type conversions
...
```typescript title="NativeHeavyCompute.ts"
export interface Spec extends NativeModule {
...
```rust title="heavy_compute_impl.rs"
#[craby_module]
...
- <TossFace>✅</TossFace> Operation takes **> 16ms** (would drop frames)
- <TossFace>✅</TossFace> CPU-intensive computations
- <TossFace>✅</TossFace> You want to keep the UI responsive
- <TossFace>✅</TossFace> Operation can fail and needs error handling

**Examples of good async methods:**

- <TossFace>👉</TossFace> Large array sorting/filtering
- <TossFace>👉</TossFace> Cryptographic operations (hashing, encryption)
- <TossFace>👉</TossFace> Complex algorithms (graph traversal, pattern matching)
- <TossFace>👉</TossFace> Heavy data processing
